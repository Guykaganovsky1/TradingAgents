  ...
  return (
    <div className="page-enter space-y-5">
      ...
      <div className="flex items-start justify-between gap-3">
        ...
        <Link
          href="/scan?auto=1"
          className="shrink-0 flex items-center gap-1.5 rounded-[10px] px-3 py-2 text-xs font-semibold text-white transition-opacity hover:opacity-90 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-indigo-400 focus-visible:ring-offset-2 focus-visible:ring-offset-slate-950"
